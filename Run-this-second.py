...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  9 14:29:36 2022
...
## Unique indexing to prevent duplications and update info for initial database
        
mydb.hotels_prices.create_index('Hotel URL', uniqueIndex = True)
docs = list(mycol.find({},{"_id": 0,"Hotel URL":1}))
i = 1
for doc in docs:
    url = doc['Hotel URL']
    obid = doc['_id']
